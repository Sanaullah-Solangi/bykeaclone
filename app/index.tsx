    ...
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.cardRow}>
          {/* CARD 1 */}
          <Card bgColor="#f8e897" iconName={"directions-car"} title="Carpool" />
          {/* CARD 2 */}
          <Card
            bgColor="#8ed1fc"
        ...
        <View style={styles.cardRow}>
          {/* CARD 1 */}
          <Card bgColor="#db3e00" iconName={"delivery-dining"} title="Dining" />
          {/* CARD 2 */}
          <Card
            bgColor="#8a54ec"
        ...
        <View style={styles.cardRow}>
          {/* CARD 1 */}
          <Card bgColor="#f78da7" iconName={"electric-car"} title="Easy" />
          {/* CARD 2 */}
          <Card bgColor="#dce775" iconName={"bike-scooter"} title="Ride" />
        </View>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  // CARD TEXT
  cardText: { textAlign: "right", fontSize: 20, alignSelf: "flex-start" },
});
